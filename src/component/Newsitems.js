...
export default class Newsitems extends Component {
    render() {
        let { title, descripiton, imageUrl, urlPath,author,publishedDate } = this.props; // this is called destructuring here this.props is an object from which respective values will be fetched
        return (
            <div className='my-3'>
                <div className="card">
